...
data:extend {
    {
        ...
        {
            {
                ...
                pipe_picture = require("__um-standalone-electromagnetic-plant__.prototypes.entity.electromagnetic-plant-pictures").pipe_pictures,
                pipe_picture_frozen = require("__um-standalone-electromagnetic-plant__.prototypes.entity.electromagnetic-plant-pictures").pipe_pictures_frozen,
        ...
        graphics_set = require("__um-standalone-electromagnetic-plant__.prototypes.entity.electromagnetic-plant-pictures").graphics_set,
        ...
        water_reflection = require("__um-standalone-electromagnetic-plant__.prototypes.entity.electromagnetic-plant-pictures").water_reflection,
    },
}